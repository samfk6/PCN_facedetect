...
{
public:
    PCN(const std::string model1,const std::string model2,const std::string model3,const std::string modelTrack,const std::string net1, const std::string net2, const std::string net3, const std::string netTrack);
